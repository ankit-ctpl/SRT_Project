...
set @Current_Datetime = (SELECT CONVERT_TZ(NOW(), '+00:00', '+00:00'));
	...
	if (Var_Method_Name = 'GetService') then
        ...
        where Org_Id = Var_Org_Id and Is_For_Agent = 1 and c027.is_active = 1 and m012.is_active = 1 ;
	...
	elseif(Var_Method_Name = 'GetServiceById') then 
        ...
        from  m012_service where Org_Id = Var_Org_Id and Is_For_Agent = 1 and ServiceType_Id = Var_SeviceType_Id and is_active = 1;
    ...
    AppliedDate varchar(40) 
        ...
        where t003.Org_Id = Var_Org_Id and Request_For_User_Id = Var_Profile_Id and MCC_Id = Var_MCC_Id;
        ...
        where t023.Org_Id = Var_Org_Id and t023.Order_For_User_Id = Var_Profile_Id  and t023.MCC_Id = Var_MCC_Id and t023.Is_Active = 1;
