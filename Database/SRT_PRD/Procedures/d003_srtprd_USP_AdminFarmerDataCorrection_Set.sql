...
DELIMITER ;;
DROP PROCEDURE IF EXISTS `USP_AdminFarmerDataCorrection_Set` ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `USP_AdminFarmerDataCorrection_Set`(
...
BEGIN        
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                AND Farmer_ID =  (SELECT Request_For_User_Id
									FROM t026_farmerdatacorrection_request
        ...
        -- update Farmer Data Correction table in case no exception is occured.
        UPDATE t026_farmerdatacorrection_request
