...
proc_Exit: BEGIN
    ...
    set sql_mode = '';
            ...
            and t038h.Dealer_Id = 'MU08241000140'
            ...
            and TRIM(LEADING '0' FROM t039.Dealer_Code ) ='700140'
			...
			Material_Id = @Material_Id  and date(date) < date(@date) order by date desc limit 1 ) ;
              ...
              /*  update f011_dealer_stock 
               ...
               -- - ifnull(Broken_Debit,0) - ifnull(ThirdParty_Debit,0)
                ...
                update f011_dealer_stock 
              set Closing_Quantity   = Opening_Quantity - (Good_Credit + Broken_Credit + ThirdParty_Credit - Good_Debit)
