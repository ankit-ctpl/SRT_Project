...
DELIMITER ;;
DROP PROCEDURE IF EXISTS `USP_AgentFarmerComplaint_Get` ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `USP_AgentFarmerComplaint_Get`(
...
BEGIN
	if (var_Method_Name = 'Get') then  
		begin
            ...
            and Complaint_For_User_Id = Var_Farmer_Id
