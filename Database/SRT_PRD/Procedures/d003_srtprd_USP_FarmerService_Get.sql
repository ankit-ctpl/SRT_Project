...
DELIMITER ;;
DROP PROCEDURE IF EXISTS `USP_FarmerService_Get` ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `USP_FarmerService_Get`(
...
set @Current_Datetime = (SELECT CONVERT_TZ(NOW(), '+00:00', '+00:00'));
    ...
    AppliedDate varchar(40) 
        ...
        where t003.Org_Id = Var_Org_Id and Request_For_User_Id = Var_Profile_Id;
        ...
        where t023.Org_Id = Var_Org_Id and t023.Order_For_User_Id = Var_Profile_Id and t023.Is_Active = 1;
