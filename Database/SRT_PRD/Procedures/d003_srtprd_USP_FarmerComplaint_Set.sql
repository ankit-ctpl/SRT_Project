...
DELIMITER ;;
DROP PROCEDURE IF EXISTS `USP_FarmerComplaint_Set` ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `USP_FarmerComplaint_Set`(
	...
	if (var_Method_Name = 'Create') then
		begin
			...
			Declare Year_Id varchar(10);
                ...
                'Farmer',var_Profile_Id,'Farmer',var_Profile_Id,@Current_Datetime , 'C035001'); 
                ...
                Org_Id = var_Org_Id and Farmer_Id = var_Profile_Id)), var_Complaint_Remark  , 1 , 'C035001' ,  'C035001' 
                );
        ...
        elseif(var_Method_Name = 'Updatecomplaint') then 
                ...
                Org_Id = var_Org_Id and Farmer_Id = var_Profile_Id)), var_Complaint_Remark  , 1 , New_Status_Id ,  Current_Status_Id 
