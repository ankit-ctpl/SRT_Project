...
DELIMITER ;;
DROP PROCEDURE IF EXISTS `USP_FarmerIncentiveScheme_Get` ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `USP_FarmerIncentiveScheme_Get`(
...
BEGIN
	...
	elseif (var_Method_Name = 'Get_Approved') then  
		begin
            ...
            and t007.Request_For_User_Id = var_Profile_Id
            and t007.Request_By_User_Id = var_Profile_Id
